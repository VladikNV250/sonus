    ...
    return (
        <div className="flex flex-col items-center relative">
            <div className="flex items-start justify-center">
                <span className="text-[140px] font-bold leading-none tracking-tighter bg-linear-to-b from-neutral-400 to-neutral-500 dark:from-white dark:to-white/70 bg-clip-text text-transparent drop-shadow-[0_4px_10px_rgba(0,0,0,0.05)] dark:drop-shadow-[0_0_30px_rgba(255,255,255,0.15)]">
                    {pitchData.note}
                </span>
